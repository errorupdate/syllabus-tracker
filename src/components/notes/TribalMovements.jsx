    ...
    return (
        <div className="font-sans text-slate-800 antialiased leading-relaxed w-full bg-[#f8fafc] min-h-screen">
            ...
            <header className={`os-glass-header fixed top-0 w-full z-50 text-white py-3 px-4 md:px-6 ${isScrolled ? 'scrolled' : ''}`}>
                <div className="w-full mx-auto flex justify-between items-center px-2 lg:px-4">
                    <div className="flex items-center gap-3 shrink-0">
                        <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-teal-500 to-amber-500 flex items-center justify-center text-white font-bold text-sm shadow-lg shadow-teal-500/25">
                            HS
                        </div>
                        <div className="hidden sm:block">
                            <h1 className="text-sm font-bold tracking-wide leading-none">Tribal Movements</h1>
            ...
            <section className="os-hero-gradient os-grid-pattern pt-28 pb-20 md:pt-36 md:pb-28 px-4 sm:px-6 lg:px-8 relative">
                <div className="absolute top-16 right-[10%] w-72 h-72 bg-teal-500/10 rounded-full blur-3xl animate-os-float pointer-events-none"></div>
                <div className="absolute bottom-10 left-[5%] w-56 h-56 bg-amber-500/10 rounded-full blur-3xl animate-os-float-delayed pointer-events-none"></div>
                ...
                <div className="w-full mx-auto relative z-10 lg:px-8">
                    ...
                    <div className="flex flex-wrap gap-4 items-center mb-12">
                        <a href="#context" onClick={(e) => scrollToSection(e, 'context')} className="inline-flex items-center gap-3 bg-gradient-to-r from-teal-600 to-emerald-500 text-white text-base font-bold px-8 py-4 rounded-xl shadow-xl shadow-teal-500/25 hover:shadow-teal-500/40 hover:-translate-y-1 transition-all duration-300 group os-pulse-glow">
                            Start Learning
                    ...
                    <div className="absolute bottom-6 left-1/2 -translate-x-1/2 os-scroll-indicator hidden md:block">
                        <svg className="w-6 h-6 text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 14l-7 7m0 0l-7-7m7 7V3"></path></svg>
                                ...
                                <section id="context" className="scroll-mt-32 os-reveal w-full px-4 sm:px-6 lg:px-8 mb-12">
                                ...
                                <section id="concepts" className="scroll-mt-32 os-reveal w-full px-4 sm:px-6 lg:px-8 mb-12">
                                ...
                                <section id="movements" className="scroll-mt-32 os-reveal w-full px-4 sm:px-6 lg:px-8 mb-16">
                                ...
                                <section id="cheatsheet" className="scroll-mt-32 os-reveal w-full px-4 sm:px-6 lg:px-8 mb-16">
